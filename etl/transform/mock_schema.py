...
MOCK_INSTRUMENTS: dict[str, InstrumentDefinition] = {
    "demographics": InstrumentDefinition(
        ...
        fields=[
            ...
            FieldDefinition("employment_status", "text"),
            FieldDefinition("food_security", "text"),
            FieldDefinition("healthcare_access", "text"),
            FieldDefinition("socioeconomic_status", "text"),
        ],
    ),
    "monthly_self_report": InstrumentDefinition(
        ...
        fields=[
            ...
            FieldDefinition("mood_score", "float"),
            FieldDefinition("sleep_quality_score", "float"),
            FieldDefinition("fatigue_score", "float"),
            FieldDefinition("attendance_score", "float"),
            FieldDefinition("coping_score", "float"),
            FieldDefinition("substance_abuse_score", "float"),
            FieldDefinition("suicidality_score", "float"),
        ],
    ),
